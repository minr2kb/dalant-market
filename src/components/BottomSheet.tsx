  ...
  return (
    ...
    >
      <Drawer.Portal>
        ...
        <Drawer.Content
          className="fixed inset-x-0 bottom-0 z-[70] flex flex-col rounded-t-3xl bg-white focus:outline-none"
          style={{ maxHeight: '90dvh' }}
          aria-describedby={undefined}
        >
          {/* drag handle must sit outside the scroll container */}
          <div className="mx-auto mt-3 mb-1 h-1 w-10 shrink-0 rounded-full bg-gray-200" />
