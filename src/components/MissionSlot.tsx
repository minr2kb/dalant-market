  ...
  return (
    <div
      className={`rounded-2xl border p-4 space-y-2 ${
        isVerified ? 'border-emerald-100 dark:border-emerald-900 bg-emerald-50 dark:bg-emerald-900/30' : 'border-gray-100 dark:border-gray-800 bg-white dark:bg-gray-900'
      }`}
    >
      <p className="text-xs font-medium text-gray-400 dark:text-gray-500">{slotNumber}회차</p>
      {isVerified ? (
